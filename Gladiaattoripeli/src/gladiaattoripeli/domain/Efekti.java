...
/**
 * Esittää animoituja efektejä linkitettynä listana koordinaattijoukkoja ja
 * piirto- asuja. Jokainen listan solmu esittää yhtä efektin animaatioruutua,
 * listalla eteenpäin liikkuessa siirrytään ruudusta toiseen.
 *
 * @author Emleri
 */
public class Efekti {
    ...
    /**
     * Tarkistaa, kuuluvatko parametreina saadut koordinaatit efektiruudun
     * piirto- alueelle.
     *
    ...
    /**
     * Palauttaa efektin ulkoasun suljettuna efektin värin määrääviin
     * HTML-tageihin.
     *
    ...
    /**
     * Käy läpi listan solmuja kunnes löytää viimeisen ja palauttaa viitteen
     * siihen.
     *
