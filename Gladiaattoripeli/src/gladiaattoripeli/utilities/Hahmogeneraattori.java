...
public class Hahmogeneraattori {
    ...
    /**
     * Luo gladiaattorin. Käyttää ihmiskeho-metodia luomaan gladiaattorin vartalon
     * ja antaa tälle asegeneraattorin luoman miekan. Gladiaattorin sijainniksi
     * asetetaan areenan keskikohta.
    ...
    /**
     * Luo lohikäärmeen. Käyttää lohikaarmeenKeho-metodia luomaan vartalon, antaa
     * lohikäärmeelle aseiksi asegeneraattorin luomat kynnet.
    ...
    /**
     * Luo vapaammin määritellyn tyyppisen hirviön. Ei pelinsisäistä käyttöä tällä 
     * hetkellä, metodi olemassa testausta ja tulevaa laajentamista varten.
